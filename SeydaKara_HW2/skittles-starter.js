...
(function() {
  ...
  function showAnswer() {
    ...
    let greenSkittles=qsa(".green")

    // 3.2. Update textContent of #count to include length of green skittles collection from 1.
    let div = id("game-play");
    let display=div.querySelector("p");
    display.classList.remove("hidden");

    let greenSkittleNumber = qs("#count");
    greenSkittleNumber.innerHTML=greenSkittles.length-1;
  ...
  function fillJar() {
    ...
    test.classList.add("skittle", getRandomColor());
