...
(function() {
  ...
  function showAnswer() {
    ...
    let length = greenSkittles.length
    
    let greenSkittleNumber = document.getElementById("count")
    greenSkittleNumber.classList.add("length")
    greenSkittleNumber.innerHTML=length
    // 3.3. Show p tag.
